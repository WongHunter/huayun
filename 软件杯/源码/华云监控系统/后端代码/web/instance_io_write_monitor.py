...
from instance.instance_io_write_monitor import InstanceIoWriteMonitor
import time
import datetime
# 生成Flask实例
app = Flask(__name__)
...
def io_write():
    ...
    jsonData = InstanceIoWriteMonitor(region_id, access_key_id, access_secret,start_time,end_time,id)
    print(jsonData)
