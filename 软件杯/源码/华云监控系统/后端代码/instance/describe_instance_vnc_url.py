...
from chinac_way_v3.ecs.v10.describe_instance_vnc_url import DescribeInstanceVncUrl
import json
from web.save_log import save_log

def Describe_Instance_Vnc_Url(region_id, access_key_id, access_secret,id):
    profile = Profile(region_id,access_key_id,access_secret)
    client = Client(profile)
    request = DescribeInstanceVncUrl()
