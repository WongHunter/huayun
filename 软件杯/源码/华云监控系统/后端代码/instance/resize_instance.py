...
from chinac_way_v3.ecs.v10.resize_instance import ResizeInstance
import json
from web.save_log import save_log

def Resize_Instance(region_id, access_key_id, access_secret,id,instance_type):
    profile = Profile(region_id,access_key_id,access_secret)
    client = Client(profile)
    request = ResizeInstance()
