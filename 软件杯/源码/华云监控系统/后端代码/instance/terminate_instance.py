...
from chinac_way_v3.ecs.v10.terminate_instance import TerminateInstance
import json
from web.save_log import save_log

def Terminate_Instance(region_id, access_key_id, access_secret,id):
    profile = Profile(region_id,access_key_id,access_secret)
    client = Client(profile)
    request = TerminateInstance()
